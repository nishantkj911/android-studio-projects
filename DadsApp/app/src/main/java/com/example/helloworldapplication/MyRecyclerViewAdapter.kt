...
class MyRecyclerViewAdapter(context : Context, cards : ArrayList<Card>) : RecyclerView.Adapter<ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        var parentLayout2 : ConstraintLayout = itemView.findViewById<ConstraintLayout>(R.id.parentLayout2)
    }
